...
subtitle_text = "Waiting for subtitles..."

coordinates_buffer = collections.deque(maxlen=5)

# Function to receive subtitles from the Vosk server
...
# Start a thread to handle receiving subtitles so it runs in the background
